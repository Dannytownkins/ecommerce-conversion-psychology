...
1. **Finding 3 (Review Count Threshold):** Five reviews increase purchase likelihood by 270% vs. zero reviews, with diminishing returns after five. This is the single most actionable finding for any store with products lacking reviews.
2. **Finding 1 (Star Rating Sweet Spot):** The 4.0-4.7 star range converts best. Perfect 5.0 ratings trigger skepticism and lower conversion. This has direct implications for review solicitation and display strategy.
3. **Finding 11 (Scarcity Backfire Online):** Time-scarcity promotions that work offline do NOT reliably work in online retail. Inventory scarcity messages can decrease daily sales by 17.6%. This challenges widespread industry assumptions.
...
|--------|------|-------|---------------------|
| Spiegel Research Center | Academic | High | Low (university research, funded by PowerReviews) |
| Barton et al. 2022 Meta-Analysis | Peer-reviewed | High | None |
| Hmurovic et al. 2023 | Peer-reviewed | High | None |
| Park et al. (UCLA Anderson) | Peer-reviewed | High | None |
| Worchel et al. 1975 | Peer-reviewed | High (for era) | None |
| Bauer et al. 2023 | Peer-reviewed | High | None |
| Schouten et al. 2020 | Peer-reviewed | High | None |
| PowerReviews Surveys | Industry survey | Medium | High (sells review platform) |
| Bazaarvoice SEI | Industry survey | Medium | High (sells UGC platform) |
| VWO/CXL Case Studies | Practitioner | Low-Medium | Medium (sell testing tools) |
| SaaS vendor claims (Fomo, ProveSource) | Vendor marketing | Low | Very High |
| CMA/EU Regulatory | Legal/regulatory | High (factual) | None |

## Key Takeaways for Implementation

1. **Get to 5 reviews per product** -- this is the single highest-ROI activity (270% lift).
2. **Don't chase perfect ratings** -- 4.0-4.7 converts best. Show negative reviews for authenticity.
3. **Prioritize review collection on expensive products** -- 380% lift vs. 190% for cheap products.
4. **Add Q&A sections** -- strong conversion signal even for non-engaged visitors.
5. **Solicit photo/video reviews** -- visual reviews convert at roughly 2x text reviews.
6. **Use real scarcity data or none at all** -- fake urgency backfires online (17.6% sales decrease) and carries regulatory risk.
7. **Match social proof to journey stage** -- star ratings in search/browse, detailed reviews on product pages, trust badges at checkout.
