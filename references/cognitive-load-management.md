...
- **Evidence Tier**: Gold
- **Quality Flag**: Peer-reviewed Gold but significant replication concerns documented in Finding 4
...
- **Quality Flag**: Underlying peer-reviewed research exists but is cited secondhand through practitioner summary; theoretical mechanism (ego depletion) has failed to replicate
...
- **Evidence Tier**: Gold
- **Quality Flag**: Primary source is Baymard (Gold); Zuko is vendor analytics data
